...
router.get('/', (req, res) => {
  ...
  if (!req.query.filters) {
    ...
    // if there is a day filter, or if the day filter is reset to null, use the first fetch, else
    // use the second fetch
    if (Object.keys(boundsObj).includes('day') && boundsObj.day !== 'null') {
